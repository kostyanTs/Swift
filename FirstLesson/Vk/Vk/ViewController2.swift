...
class ViewController2: UIViewController {
    ...
    private let countFriends = "78"
    private let countSubcribes = "150"
    private let countGroups = "288"
    
    private let comment = "  :))"
    private let id = "  @1111111111111"
    private let birthday  = "  1 марта 2000 г."
    private let city = "  Караганда"
    private let subcribers = "  130"
